...
'''
Based on this kernel: https://www.kaggle.com/act444/lb-0-158-xgb-handcrafted-leaky?scriptVersionId=1188812
Public leaderboard score: 0.16553

To run this script you'll need Abhishek's features: https://www.kaggle.com/c/quora-question-pairs/discussion/31284
Github: https://github.com/abhishekkrthakur/is_that_a_duplicate_quora_question
Download of train and test: https://drive.google.com/open?id=0B-2wHXRXhQPqUlpyOWJYU2lYUUE
...
def main():
    ...
    df_train = pd.read_csv('./abisheks_features/train_features.csv', encoding="ISO-8859-1")
    ...
    df_test = pd.read_csv('./abisheks_features/test_features.csv', encoding="ISO-8859-1")
